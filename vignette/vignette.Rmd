...
### Package highlights
 * option is available to tune only one hyperparameter and set $\alpha$: $\lambda_2$ = $\alpha$ $\lambda_1$
 * option is available to tune hyperparameters by maximizing AUC for the binary outcomes
