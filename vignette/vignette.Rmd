 ...
 * to tune only one hyperparameter and set $\alpha$: $\lambda_2$ = $\alpha$ $\lambda_1$;
 * to tune hyperparameters by maximizing *AUC* for the binary outcomes;
 * to add unpenalized covariates to the mode;
 * to utilize sparse/bigmatrix data format for more efficient and flexible use of the package.
